...
<head>
    ...
    <title>Reset Password - Clean City Collector</title>
    <!-- Favicon -->
                    ...
                    <div class="w-full max-w-md">
                        <div class="bg-white rounded-2xl shadow-2xl p-8 animate-on-scroll stagger-1">
                            <div class="text-center mb-8">
                                ...
                                <p class="text-gray-600">Enter your new password to regain access to your collector account</p>
                            </div>

                            <form method="POST" action="{{ route('collector.password.store') }}" class="space-y-6">
                                @csrf
