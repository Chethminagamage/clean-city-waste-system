...
<div class="container mx-auto px-4 py-8 max-w-4xl">
    ...
    <div class="flex items-center mb-6">
        ...
        <div>
            ...
            <p class="text-gray-600">Your feedback and our response</p>
        </div>
    </div>
        ...
        <div class="lg:col-span-2">
            ...
            <div class="bg-white rounded-lg shadow p-6 mb-6">
                ...
                <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <div class="font-medium text-gray-900">{{ $feedback->rating }}/5 Rating</div>
                ...
                <!-- Your Feedback -->
                <div class="mb-6">
                    <h3 class="text-lg font-medium text-gray-900 mb-3">Your Feedback</h3>
                    @if($feedback->message)
                    ...
                    @else
                        <div class="bg-gray-50 rounded-lg p-4">
                            <p class="text-gray-600 italic">No written feedback provided - Rating only</p>
                        </div>
                    @endif
                ...
                @if($feedback->admin_response)
                    <div class="border-t pt-6">
                        <h3 class="text-lg font-medium text-gray-900 mb-3">Our Response</h3>
                        <div class="bg-green-50 border-l-4 border-green-400 p-4 rounded-r-lg">
                            <p class="text-green-900 whitespace-pre-wrap">{{ $feedback->admin_response }}</p>
                    ...
                    <div class="border-t pt-6">
                        <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <h4 class="text-yellow-800 font-medium">Response Pending</h4>
            ...
            @if($feedback->wasteReport)
                <div class="bg-white rounded-lg shadow p-6">
                    <h3 class="text-lg font-medium text-gray-900 mb-4">Related Waste Report</h3>
                    <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                        <div class="flex items-center justify-between">
                            <div>
                                <h4 class="font-medium text-blue-900">Report #{{ $feedback->wasteReport->id }}</h4>
                                <p class="text-blue-700 text-sm">{{ $feedback->wasteReport->description }}</p>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="space-y-3">
                    ...
                    <div>
                        ...
                        <p class="text-gray-900">{{ $feedback->rating }} out of 5 stars</p>
                    </div>
                    <div>
                        <span class="text-sm font-medium text-gray-500">Submitted</span>
                        <p class="text-gray-900">{{ $feedback->created_at->format('M j, Y g:i A') }}</p>
                    </div>
                    @if($feedback->admin_responded_at)
                        <div>
                            <span class="text-sm font-medium text-gray-500">Response Time</span>
                            <p class="text-gray-900">{{ $feedback->created_at->diffInHours($feedback->admin_responded_at) }} hours</p>
                        </div>
                    @endif
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="space-y-3">
                    ...
                    @if($feedback->wasteReport)
                        <a href="{{ route('resident.reports.show', $feedback->wasteReport->id) }}" 
                           class="block w-full text-center px-4 py-2 border border-gray-300 text-gray-700 rounded hover:bg-gray-50">
                            🔍 View Related Report
                        </a>
                    @endif
            ...
            <!-- Help -->
            <div class="bg-gray-50 rounded-lg p-4">
                <h4 class="font-medium text-gray-900 mb-2">Need More Help?</h4>
