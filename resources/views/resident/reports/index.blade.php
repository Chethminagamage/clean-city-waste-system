  ...
  <div class="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700 mb-6 transition-colors duration-300">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-6">
      <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <h1 class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white flex items-center transition-colors duration-300">
          ...
          <p class="text-gray-600 dark:text-gray-300 mt-1 text-sm transition-colors duration-300">Track and manage your waste collection reports</p>
        </div>
