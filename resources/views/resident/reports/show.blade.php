        ...
        <p class="text-gray-600 dark:text-gray-400 text-sm mt-2">
          ...
          @endif
            ...
            <div class="relative flex items-start space-x-4">
              ...
              <div class="flex-1 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 p-3 sm:p-4 rounded-xl border border-blue-100 dark:border-blue-700/30">
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                  <h4 class="text-base font-bold text-gray-800 dark:text-white">Completion Photo</h4>
                  <span class="inline-flex items-center px-2 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300 text-xs font-semibold rounded-full">
                    <svg class="w-2 h-2 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z"/>
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 13a3 3 0 11-6 0 3 3 0 016 0z"/>
                ...
                <p class="text-gray-600 dark:text-gray-400 text-sm mt-2">Proof of completion captured by collector</p>
                
                <!-- Completion Image -->
                <div class="mt-4 pt-4 border-t border-blue-200 dark:border-blue-700">
                  <div class="bg-white dark:bg-blue-800/20 p-3 rounded-lg border border-blue-200 dark:border-blue-600">
                    <img src="{{ asset('storage/' . $report->completion_image_path) }}" 
                         alt="Completion Photo" 
                         class="w-full max-h-64 object-cover rounded-lg border border-blue-300 dark:border-blue-600 cursor-pointer hover:opacity-90 transition-opacity"
                         onclick="window.open('{{ asset('storage/' . $report->completion_image_path) }}', '_blank')">
                    <div class="mt-2 flex flex-col sm:flex-row sm:items-center justify-between gap-2 text-xs">
                      <p class="text-blue-600 dark:text-blue-400">
                        <svg class="w-3 h-3 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                        Uploaded: {{ $report->completion_image_uploaded_at ? $report->completion_image_uploaded_at->format('M d, Y h:i A') : 'Recently' }}
                      </p>
                      <span class="text-blue-700 dark:text-blue-300 font-medium">Click to view full size</span>
                    </div>
                    ...
                    <div class="mt-3 p-3 bg-blue-50 dark:bg-blue-900/30 rounded-lg border border-blue-200 dark:border-blue-700">
                      <p class="text-sm text-blue-800 dark:text-blue-200"><strong>Collector Notes:</strong> {{ $report->completion_notes }}</p>
                    </div>
                    @endif
                  </div>
                </div>
