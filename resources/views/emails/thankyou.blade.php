...
<body style="margin: 0; padding: 0; background-color: #f1fcf5; font-family: 'Segoe UI', sans-serif; color: #333;">
    <table width="100%" cellpadding="0" cellspacing="0" style="padding: 40px 0;">
        <tr>
            <td align="center">
                <table width="600" cellpadding="0" cellspacing="0" style="background: #ffffff; border-radius: 12px; box-shadow: 0 6px 20px rgba(0,0,0,0.06); overflow: hidden;">
                    <!-- Header -->
                    <tr>
                    ...
                    <tr>
                        <td style="padding: 30px 40px;">
                            <h2 style="margin-top: 0; color: #2f855a;">Hello {{ $name }},</h2>
